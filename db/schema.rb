...
ActiveRecord::Schema.define(version: 20150623211114) do
  ...
  add_index "forum_replies", ["forum_reply_id"], name: "index_forum_replies_on_forum_reply_id"
  add_index "forum_replies", ["forum_thread_id"], name: "index_forum_replies_on_forum_thread_id"
